...
<div class="container">
    <div class="siteIcon"><img src="/Public/statics/img/icon/icon.png" alt="" data-toggle="tooltip" data-placement="top"
                               title="欢迎使用进销存beta0.1版本" draggable="false"/></div>
    <form action="/Home/Login/login" method="post" autocomplete="off" class="form-signin">
