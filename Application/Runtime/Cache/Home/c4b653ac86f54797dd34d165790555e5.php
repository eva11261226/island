    ...
    <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <form action="/Home/Buy/index" method="post" class="navbar-form " role="search">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="search_name" value="<?php echo ($dealerName); ?>" autocomplete="off"
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($buyAllInfo)): foreach($buyAllInfo as $key=>$buys): ?><tr>
                            <td align="center" class="article-title"><?php echo ($buys['dealer_name']); ?></td>
                            <!--<td align="center"><?php echo ($buys['number']); ?></td>-->
                            <td align="center" class="hidden-sm"><?php echo ($buys['number_total']); ?></td>
                            <td align="center" class="hidden-sm"><?php echo ($buys['money_total']); ?></td>
                            <td align="center"><?php echo ($buys['add_time']); ?></td>
                            <td align="center">
                                <a href="/Home/buy/detail/buyId/<?php echo ($buys['id']); ?>" style="color: blue">详情</a>
                                <a href="/Home/buy/del/buyId/<?php echo ($buys['id']); ?>" style="color: red"
                                rel="1">删除</a>
                            </td>
