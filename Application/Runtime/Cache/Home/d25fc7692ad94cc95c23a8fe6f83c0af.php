...
<section class="container-fluid">
    ...
    <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <h1 class="page-header">产品列表<span class="badge">共<?php echo ($count); ?>个产品</span></h1>
            ...
            <form action="/Home/Sale/index" method="post" class="navbar-form " role="search">
                <div class="input-group">
                    <input type="text" class="form-control" name="search_name" value="<?php echo ($projectName); ?>" autocomplete="off" placeholder="搜索产品" maxlength="15">
                    <span class="input-group-btn">
                        <button class="btn btn-default" type="submit">搜索</button>
                    </span>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($projectInfo)): foreach($projectInfo as $key=>$projects): ?><tr>
                            ...
                            <td align="center">
                                ...
                                <a href="/Home/Project/del/projectId/<?php echo ($projects['id']); ?>" style="color: red"
                                   rel="1">删除</a>
                            </td>
